...
function setup() {
	...
	// button3.style("background", "rgba(0, 0, 0, 0.7)");
	...
	// button4.style("background", "rgba(0, 0, 0, 0.5)");
	button5 = createElement("div");
	button5.position(4*ww/7, wh-300);
	button5.id("button5");
	button5.size(ww/7, 300);
	button5.mouseClicked(switchToSecond);
	// button5.style("background", "rgba(0, 0, 0, 0.5)");
	button6 = createElement("div");
	button6.position(5*ww/7, wh-300);
	button6.id("button6");
	button6.size(ww/7, 300);
	button6.mouseClicked(switchToSecond);
	// button6.style("background", "rgba(0, 0, 0, 0.5)");
	button7 = createElement("div");
	button7.position(6*ww/7, wh-300);
	button7.id("button7");
	button7.size(ww/7, 300);
	button7.mouseClicked(switchToSecond);
	// button7.style("background", "rgba(0, 0, 0, 0.5)");

	//draw second view
	// temp1 = createElement("div");
	// temp1.id("temp1");
	// temp1.size(ww, buttonHeight/5);
	// temp1.position(0, wh-buttonHeight);
	// temp1.style("background", "rgb("+weatherColor[0][0][0]+", "+weatherColor[0][0][1]+", "+weatherColor[0][0][2]+")");
	// temp1.style("display","none");
	// temp2 = createElement("div");
	// temp2.id("temp2");
	// temp2.size(ww, buttonHeight*3/10);
	// temp2.position(0, wh-buttonHeight+wh/5);
	// temp2.style("background", "rgb("+weatherColor[0][1][0]+", "+weatherColor[0][1][1]+", "+weatherColor[0][1][2]+")");
	// temp2.style("display","none");
	// temp3 = createElement("div");
	// temp3.id("temp3");
	// temp3.size(ww, buttonHeight/5);
	// temp3.position(0, wh-buttonHeight+wh/2);
	// temp3.style("background", "rgb("+weatherColor[0][2][0]+", "+weatherColor[0][2][1]+", "+weatherColor[0][2][2]+")");
	// temp3.style("display","none");
	// temp4 = createElement("div");
	// temp4.id("temp4");
	// temp4.size(ww, buttonHeight*3/10);
	// temp4.position(0, wh-buttonHeight+wh*7/10);
	// temp4.style("background", "rgb("+weatherColor[0][3][0]+", "+weatherColor[0][3][1]+", "+weatherColor[0][3][2]+")");
	...
	//secondViewContainer.style("background", "-webkit-gradient(linear, 0 0, 0 100%, from(#dedede), color-stop(8%, white), color-stop(20%, red)")
